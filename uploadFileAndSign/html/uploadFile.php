...
<div class="banner">
	<div class="container">
		<div class="banner-main">
			<h3>上传文件</h3>
 <!--Upload File  -->
  <form name="postForm" action="../php/uploadFile.php" method="post" enctype="multipart/form-data" onsubmit="return Judgelog()">
		 <div class="bwn">

        <input name="myFile" id="myFile" type="file" value="" />
				<font size="4" style="font-weight:bold" color="white">请填写您的文件密码，密码仅限于数字、字母，其他匿名用户必须获知您的文件密码才能对您上传的文件解密</font></br><br>
				<input type="password" name="filekey" class="password" /></br></br></br>
        <input name="subBtn" id="subBtn" type="submit" value="点击上传" />
